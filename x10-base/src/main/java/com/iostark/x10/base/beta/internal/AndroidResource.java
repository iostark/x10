...
public class AndroidResource {
    ...
    @SuppressWarnings("PMD.LawOfDemeter")
    public AndroidResource copyToDefaultExternalStorage(final InputStream inputStream, final String filename) throws IOException {
        copyTo(inputStream, getDefaultFilePath(filename).getCanonicalPath());
        return this;
    }

    @SuppressWarnings("PMD.LawOfDemeter")
    public AndroidResource copyRawResourceTo(final int resourceId, final String filename) throws IOException {
    ...
    public AndroidResource copyTo(final InputStream inputStream, final String absoluteFilePathDestination) throws IOException {
