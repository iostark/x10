...
public class BitmapViewOperation {
  ...
  public Bitmap createBitmap(final View view) {
    final Bitmap bitmap =
        createBitmapFromView(view, view.getMeasuredWidth(), view.getMeasuredHeight());
    return bitmap;
  }

  private static Bitmap createBitmapFromView(
      final View view, final int bitmapWidth, final int bitmapHeight) {
