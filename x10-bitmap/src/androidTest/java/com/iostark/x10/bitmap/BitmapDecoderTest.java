...
public class BitmapDecoderTest extends ContextInstrumentedTest {
    ...
    public void sampleDecodeWithResourceId() {
        ...
        Bitmap sampledBitmap = decoder.decodeSampledBitmap(R.drawable.default_image, getResources(), imageSize, imageSize);
    ...
    public void sampleDecodeWithFilePath() throws IOException {
        ...
        AndroidResource androidResource = new AndroidResource(getContext()).copyRawResourceTo(R.raw.default_image, filename);

        BitmapDecoder decoder = new BitmapDecoder();
        Bitmap sampledBitmap = decoder.decodeSampledBitmap(
                androidResource.getDefaultFilePath(filename).getCanonicalPath(),
                imageSize, imageSize);
