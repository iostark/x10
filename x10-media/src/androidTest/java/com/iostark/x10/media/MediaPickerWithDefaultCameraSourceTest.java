...
public class MediaPickerWithDefaultCameraSourceTest {
  ...
  @Rule
  public IntentsTestRule<MediaPickerActivity> mIntentsRule =
      new IntentsTestRule<MediaPickerActivity>(MediaPickerActivity.class);
  ...
  public void testWithImagePicked() {
    ...
    activity.pickMedia(
        new MediaPickerListener<String>() {
          @Override
  ...
  public void testWithImageNotPicked() {
    ...
    Intent intent = new Intent();
    Instrumentation.ActivityResult result =
        new Instrumentation.ActivityResult(Activity.RESULT_CANCELED, intent);
