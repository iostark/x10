...
public class SoftKeyboardTest extends ActivityInstrumentedTest<SoftKeyboardActivity> {
    ...
    public void testHideKeyboard() {
        ResultReceiver showResultReceiver = new ResultReceiver(new Handler(Looper.getMainLooper())) {
            @Override
            protected void onReceiveResult(int resultCode, Bundle resultData) {
                ResultReceiver hideResultReceiver = new ResultReceiver(new Handler(Looper.getMainLooper())) {
                    @Override
                    protected void onReceiveResult(int resultCode, Bundle resultData) {
                        countingResource.decrement();
