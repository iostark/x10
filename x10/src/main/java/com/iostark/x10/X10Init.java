...
public class X10Init {
     ...
     * @since V0_5_0
     */
    public X10Init useContext(@NonNull
                                 final Context context) {
        Preconditions.checkNotNull(context, "Context cannot be null");
        Preconditions.checkArgument(context instanceof Application, "Context must be Application wide context");
        this.context = context;
        return this;
    }

    /**
     * Declare this library is used in a non commercial project.
     * // FIXME Point to dual licensing ?
     *
     * @return The current object
     * @since V0_5_0
     */
    ...
    /**
     * Declare this library is used in a commercial project.
     * // FIXME Point to dual licensing ?
     *
