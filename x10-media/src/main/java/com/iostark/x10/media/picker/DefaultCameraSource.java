...
public class DefaultCameraSource<MediaType> extends BaseMediaSource<MediaType> {
  private static final int REQUEST_CODE =
      GlobalNumberIdentifierGenerator.INT_IDENTIFIER_GENERATOR.next();
  private static final String REQUEST_CODE_KEY = "request_code";
  private static final String KEY_EXPECTED_MEDIA_PATH =
      X10BuildConfig.LIBRARY_ID + ".media_path_expected";
  ...
  public void onSaveInstanceState(final Bundle outState) {
    final X10Bundle x10Bundle =
        new X10Bundle(
            outState, ModuleConfig.MODULE_NAME, DefaultCameraSource.class.getSimpleName());
  ...
  public void onRestoreInstanceState(final Bundle savedInstanceState) {
    final X10Bundle x10Bundle =
        new X10Bundle(
            ...
            DefaultCameraSource.class.getSimpleName());
  ...
  @SuppressWarnings("PMD.LawOfDemeter")
  private void pickPictureFromCamera(final @NonNull Activity activity, final int requestCode)
      throws IOException {
  ...
  protected MediaType convertMediaPathToMediaType(final String mediaPath)
    ...
    try {
      ...
      final ClassCastException classCastException =
          new ClassCastException(
              "You should override DefaultCameraSource.convertMediaPathToMediaType(...)");
