...
public class DefaultGallerySource<MediaType> extends BaseMediaSource<MediaType> {
    ...
    public void onSaveInstanceState(final Bundle outState) {
        final X10Bundle x10Bundle = new X10Bundle(outState, ModuleConfig.MODULE_NAME, DefaultGallerySource.class.getSimpleName());
    ...
    public void onRestoreInstanceState(final Bundle savedInstanceState) {
        final X10Bundle x10Bundle = new X10Bundle(savedInstanceState, ModuleConfig.MODULE_NAME, DefaultGallerySource.class.getSimpleName());
    ...
    private void handleMediaFromGallery(final Intent data) {
        ...
        final CursorLoader cursorLoader = new CursorLoader(activity, selectedMediaUri, projection, null, null, null);
    ...
    protected MediaType convertMediaPathToMediaType(final String mediaPath) throws ClassCastException {
        try {
            ...
            final ClassCastException wrappedException = new ClassCastException("You should override DefaultGallerySource.convertMediaPathToMediaType(...)");
