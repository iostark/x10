...
public class BasePermissionRequestHandler implements PermissionRequestHandler {
     ...
     */
    @Override
    public void onShowPermissionRationale(final String permissionName, final @NonNull PermissionRationaleResult rationaleResult) {
    ...
    public void onNeverAskAgainPermission(final String permissionName, final int currentPermissionStatus) {
