...
public class BitmapDecoder {
     ...
     * @since V0_5_0
     */
    @SuppressFBWarnings(value = "EI_EXPOSE_REP2", justification = "Use external representation because data can be really large")
    @KeepEntryPoint
     ...
     */
    @KeepEntryPoint
    public Bitmap decodeSampledBitmap(final int resourceId, final Resources resources, final int reqWidth, final int reqHeight) {
