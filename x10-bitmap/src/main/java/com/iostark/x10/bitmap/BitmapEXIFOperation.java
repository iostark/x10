...
public class BitmapEXIFOperation {
   ...
   * @throws IOException If imageSourcePath cannot be read Details: http://www.exiv2.org/Exif2-2.PDF
   *     and http://sylvana.net/jpegcrop/exif_orientation.html for details about EXIF orientation
   *     values
   * @since V0_5_0
   */
  @KeepEntryPoint
  ...
  private Bitmap rotate(final String exifImagePath, final int toExitOrientation)
      throws IOException {
    if (toExitOrientation != 1) {
      throw new UnsupportedOperationException(
          "Rotating bitmap to requested EXIF orientation is not suppoted for now");
    }
